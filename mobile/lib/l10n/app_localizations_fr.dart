...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get settingsPrivacyPolicySubtitle =>
      'Comment sont traitées vos informations personnelles';
  ...
  @override
  String get licensesPriceFree => 'Gratuit';
  ...
  @override
  String get licensesLaunchPromotion => 'Promotion de lancement';

  @override
  String get licensesPromotionDetails => 'Détail de la promotion';
  ...
  String get housingPlanExpenseAmountsIncomplete =>
      'Chaque dépense doit avoir un montant supérieur à zéro.';

  @override
  String get housingPlanExpenseRecurrenceIncomplete =>
      'Indiquez la récurrence de chaque dépense récurrente.';

  @override
  String get housingPlanExpenseSplitsIncomplete =>
      'La répartition de chaque dépense doit totaliser 100 %.';

  @override
  String get housingPlanExpenseParticipantsMissing =>
      'Il manque des participants pour valider les dépenses.';
  ...
  @override
  String get housingLicenseReadonlyBannerTitle => 'Logement en lecture seule';

  @override
  String get housingLicenseReadonlyBannerBody =>
      'L’essai et la période de grâce sont terminés, sans abonnement logement. Vous pouvez consulter l’historique, mais pas enregistrer de nouvelle dépense. L’export reste disponible dans Paramètres. Ouvrez Licences pour souscrire.';

  @override
  String get housingLicenseGraceBannerTitle => 'Période de grâce';
  ...
  String housingLicenseGraceBannerBody(int days, String date) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Le logement reste utilisable jusqu’au $date ($days jours restants). Ouvrez Licences pour souscrire.',
      one:
          'Le logement reste utilisable jusqu’au $date (1 jour restant). Ouvrez Licences pour souscrire.',
    );
    return '$_temp0';
  }
  ...
  String get activityLogKindVehicleUseSessionStartReceived =>
      'Début de session de partage reçu';

  @override
  String get activityLogKindVehicleUseSessionEndSent =>
      'Fin de session de partage envoyée';
  ...
  String get pushNotificationVehicleSharingOfferAcceptTitle =>
      'Partage de véhicule accepté';

  @override
  String get pushNotificationVehicleSharingOfferAcceptBody =>
      'Ouvrez Partage de véhicule pour voir le partage actif.';
  ...
  String pushNotificationHousingTrialStartedBody(String date) {
    return 'Vous pouvez utiliser le logement jusqu’au $date. Les achats se font dans Licences.';
  }

  @override
  String get pushNotificationHousingTrialReminderTitle =>
      'Rappel d’essai logement';

  @override
  String pushNotificationHousingTrialWeekLeftBody(String date) {
    return 'L’essai logement se termine le $date (7 jours restants). Ouvrez Licences quand vous serez prêt.';
  }
  ...
  String pushNotificationHousingTrialDaysLeftBody(int days, String date) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'L’essai logement se termine le $date ($days jours restants). Ouvrez Licences quand vous serez prêt.',
      one:
          'L’essai logement se termine le $date (1 jour restant). Ouvrez Licences quand vous serez prêt.',
    );
    return '$_temp0';
  }
  ...
  String pushNotificationHousingGraceReminderBody(int days, String date) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Il reste $days jours (jusqu’au $date) pour souscrire dans Licences. Le logement reste utilisable.',
      one:
          'Il reste 1 jour (jusqu’au $date) pour souscrire dans Licences. Le logement reste utilisable.',
    );
    return '$_temp0';
  }
  ...
  String get pushNotificationHousingTrialEndedBody =>
      'Le module de Logement passe en mode lecture seule. Les achats se font dans Licences.';

  @override
  String get pushNotificationVehicleTrialStartedTitle =>
      'Essai véhicule commencé';

  @override
  String pushNotificationVehicleTrialStartedBody(String date) {
    return 'Vous pouvez utiliser le véhicule jusqu’au $date. Les achats se font dans Licences.';
  }

  @override
  String get pushNotificationVehicleTrialReminderTitle =>
      'Rappel d’essai véhicule';

  @override
  String pushNotificationVehicleTrialWeekLeftBody(String date) {
    return 'L’essai véhicule se termine le $date (7 jours restants). Ouvrez Licences quand vous serez prêt.';
  }
  ...
  String pushNotificationVehicleTrialDaysLeftBody(int days, String date) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'L’essai véhicule se termine le $date ($days jours restants). Ouvrez Licences quand vous serez prêt.',
      one:
          'L’essai véhicule se termine le $date (1 jour restant). Ouvrez Licences quand vous serez prêt.',
    );
    return '$_temp0';
  }
  ...
  String get pushNotificationVehicleTrialEndedBody =>
      'Le module de Véhicule passe en mode lecture seule. Les achats se font dans Licences.';

  @override
  String get pushNotificationVehicleGraceReminderTitle =>
      'Période de grâce véhicule';
  ...
  String pushNotificationVehicleGraceReminderBody(int days, String date) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Il reste $days jours (jusqu’au $date) pour souscrire dans Licences. Le véhicule reste utilisable.',
      one:
          'Il reste 1 jour (jusqu’au $date) pour souscrire dans Licences. Le véhicule reste utilisable.',
    );
    return '$_temp0';
  }
  ...
  String get pushNotificationVehicleSharingDisabledBody =>
      'Le module Partage requiert les deux licences de Véhicule et Partage valides. Les achats se font dans Licences.';
  ...
  @override
  String get vehicleUsageBalanceMyMileage => 'Mon kilométrage';

  @override
  String get vehicleUsageBalanceMyMileageMiles => 'Mon mileage';

  @override
  String get vehicleUsageBalanceEstimatedFuel => 'Carburant utilisé';

  @override
  String get vehicleUsageBalanceBorrowerFuel => 'Achats de carburant';

  @override
  String get vehicleUsageBalanceBorrowerMaintenance => 'Entretiens';

  @override
  String get vehicleUsageBalanceCompensation => 'Compensation d\'utilisation';
  ...
  String get vehicleUsageBalanceMileageSessionDatesBlurb =>
      'Selon les dates de fin de session d\'utilisation';
  ...
  String vehicleUsageBalanceFuelConsumptionBlurb(
    ...
    return 'Consommation moyenne : $consumption $volumeUnit / 100 $distanceUnit';
  }
  ...
  String get vehicleUsageBalanceFuelPurchasesDeductedBlurb =>
      'La somme des achats de carburant que vous avez fait est déduite';

  @override
  String get vehicleUsageBalanceMaintenanceDeductedBlurb =>
      'La somme des entretiens que vous avez fait est déduite';
  ...
  @override
  String get vehicleDistanceUnitKilometre => 'kilomètre';
  ...
  String vehicleConsumptionEstimationModeSimpleDescription(
    ...
    return 'Seulement le nombre de $volumeUnitWord par 100 $distanceUnit';
  }
  ...
  String vehicleConsumptionEstimationModeDetailedDescription(
    ...
    return '$volumeUnitWordCap par 100 $distanceUnit pour la conduite sur route / en ville / dans le traffic';
  }
  ...
  @override
  String get vehicleLiquidVolumeUnitLitres => 'litres';

  @override
  String get vehicleLiquidVolumeUnitUsGallons => 'gallons US';

  @override
  String get vehicleLiquidVolumeUnitImperialGallons => 'gallons impériaux';

  @override
  String get vehicleLiquidVolumeUnitLitresCap => 'Litres';

  @override
  String get vehicleLiquidVolumeUnitUsGallonsCap => 'Gallons US';

  @override
  String get vehicleLiquidVolumeUnitImperialGallonsCap => 'Gallons impériaux';
  ...
  String vehicleConsumptionSimpleEstimate(
    ...
    return 'Consommation : $value $volumeUnit/100 $distanceUnit';
  }
  ...
  @override
  String get vehicleSharingShareableTitle => 'Véhicule partageable';

  @override
  String get vehicleSharingShareableTitlePlural => 'Véhicules partageables';

  @override
  String get vehicleSharingAccessibleTitle => 'Véhicule accessible';

  @override
  String get vehicleSharingAccessibleTitlePlural => 'Véhicules accessibles';

  @override
  String get vehicleSharingPendingOfferTitle => 'Offre en attente';

  @override
  String get vehicleSharingPendingOfferTitlePlural => 'Offres en attente';

  @override
  String get vehicleSharingModuleCapabilitiesButton => 'Que permets ce module';

  @override
  String get vehicleSharingModuleCapabilitiesBody1 =>
      'Le module de Partage permet d\'entrer des données d\'utilisation du véhicule d\'une autre personne. Il permet aussi d\'inviter vos contacts afin qu\'il puissent utiliser votre véhicule.';

  @override
  String get vehicleSharingModuleCapabilitiesBody2 =>
      'Dans les deux cas, la licence Partage doit être activée. Pour partager votre véhicule, la licence Véhicule doit aussi être activée.';

  @override
  String get vehicleSharingModuleCapabilitiesLicensesHeading =>
      'Vous avez actuellement les licences suivantes:';

  @override
  String get vehicleSharingEmptyNone => 'Aucun';

  @override
  String get vehicleSharingEmptyNoneFeminine => 'Aucune';

  @override
  String get vehicleSharingSharesDetailTitle => 'Partages';
  ...
  String vehicleSharingInviteRateLabel(String unit) {
    return 'Sous par $unit d\'utilisation (optionnel)';
  }
  ...
  String vehicleSharingInviteDisclaimerBody1(String unit) {
    return 'Seul le montant par $unit sera suivi par l\'application.';
  }
  ...
  @override
  String get vehicleSharingOfferDeadlineTitle => 'Délai de réponse';
