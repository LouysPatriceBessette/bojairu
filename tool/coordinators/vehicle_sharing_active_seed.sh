#!/usr/bin/env bash
# Coordinator: seed-only vehicle sharing ACTIVE state (end of offer happy path).
...
SCENARIO_ID="${COMPARTARENTA_MULTI_SCENARIO_ID:-vehicle_sharing_active_seed}"
...
echo "================================================================================"
echo "Vehicle sharing ACTIVE seed — end state of offer happy path (manual follow-up)"
...
echo "Manual: both AVDs seeded to active share (Louys crochet vert, Monica carte accessible)."
exit 0
